...
if (! function_exists('twenty_twenty_one_setup')) {
	...
	function twenty_twenty_one_setup()
	{
		...
		{
			register_nav_menu('custom-menu', __('Main Menu'));
		}
...
function twenty_twenty_one_scripts()
{
	...
	// to detect if the current browser is internet explorer.
	// styles
	wp_enqueue_style('biofuels-style', get_template_directory_uri() . '/dist/assets/css/app.bundle.css', array(), wp_get_theme()->get('Version'));

	// Jquery
	wp_register_script('biofuels-script-jquery-defer', get_template_directory_uri() . '/src/js/plugins/jquery.min.js', '', wp_get_theme()->get('Version'), false);
	wp_enqueue_script('biofuels-script-jquery-defer');

	// slick
	wp_register_script('biofuels-script-slick-defer', get_template_directory_uri() . '/src/js/plugins/slick.min.js', '', wp_get_theme()->get('Version'), false);
	wp_enqueue_script('biofuels-script-slick-defer');

	// bundle
	wp_register_script('biofuels-script-bundle-defer', get_template_directory_uri() . '/dist/assets/js/app.bundle.js', '', wp_get_theme()->get('Version'), false);
	wp_enqueue_script('biofuels-script-bundle-defer');
